            ...
            <h2 class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('transfer-master')}}">Transfer</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Transfer Receipt</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="chalan-card">
                <div class="head">
                    ...
                    <div class="child">
                        ...
                        @if($firstTransaction)
                        <p> <b>Transfer From:</b>  {{ $firstTransaction['from_branch_name'] }}  <br />
                         <b>Transfer To:</b>  {{ $firstTransaction['to_branch_name'] }} </p>
                        @endif
                            <!-- Amreli,<br />
                            GJ 360 002</p> -->
                    </div>
                    <div class="child">
                        <p><b>Order Date:</b>{{$firstTransaction['orders'][0]['order_date'] }}</p>
                    </div>
                </div>
                <div class="body">
                    <div class="child">
                        ...
                        @if($firstTransaction['orders'][0]['order_type'] == 1)
                            ...
                            <p>Order Type:<b>Order </b></p>
                        @else
                        <p>Order Type:<b>Reparing</b></p>
                    ...
                    <div class="table-my">
                        ...
                        <div class="table-col">
                                ...
                                <div>
                                    <p>{{$transaction['items'][0]['item_name']}}</p>
                                </div>
                    ...
                    <div class="child" style="display:flex; align-items:start;">
                        ...
                        <div class="w-100">
                            ...
                            <p><b>Transfer By:</b> {{$firstTransaction['trans_user']['name']}}</p>
                            <br />
